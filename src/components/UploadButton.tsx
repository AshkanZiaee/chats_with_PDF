          ...
          >
            <div className="flex items-center justify-center h-full w-full">
              <label
                ...
                className="flex flex-col items-center justify-center w-full h-full rounded-lg cursor-pointer bg-gray-200 hover:bg-gray-100 opacity-80"
              >
