...
const Dashboard = ({ subscriptionPlan }: PageProps) => {
  ...
  const [currentlyDeleteingFile, setCurrentlyDeleteingFile] = useState<
    string | null
  >();
    ...
    <main className="mx-auto max-w-7xl md:p-10">
      ...
      {files && files?.length !== 0 ? (
                ...
                >
                  ...
                  >
                    <div className="pt-6 px-6 flex w-full items-center justify-between space-x-6">
                      <div className="h-10 w-10 flex-shrink-0 rounded-full bg-gradient-to-r from-violet-500 to-red-500" />
        ...
        <div className="mt-16 flex flex-col items-center gap-2">
          ...
          <h3 className="font-semibold text-x1">Boo! this place is empty</h3>
